...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <h1 class="mx-3"> Lista das transacoes </h1>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.forEach(element => {
                        ...
                        tabela += '<td>';
                        tabela += '<a href="transacoes/' + element.id + '/edit" class="btn btn-success">Editar</a></td>';
                        tabela += '<td>';
                        tabela += '<form action="transacoes/delete/' + element.id + '" method="post">';
                        tabela += '@csrf';
                        tabela += '@method("delete")';
                        tabela += '<button class="btn btn-danger">Deletar</button></form></td></tr>';
                    });
